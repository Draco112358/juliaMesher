...
# !!! Main.UserApp is configured as an alias for Main.JuliaMesher and you might encounter it in some tests
using Main.JuliaMesher, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "JuliaMesher tests" begin
  @includetests ARGS
end
